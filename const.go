...
func init() {
	...
	*/
	...
	publicationsList := []_pubData{
		_pubData{name: "cosmo", ramsDomain: "rams.cosmopolitan.com", displayName: "Cosmopolitan", notificationAlias: "cosmo"},
		_pubData{name: "seventeen", ramsDomain: "rams.seventeen.com", displayName: "Seventeen", notificationAlias: "seventeen"},
		_pubData{name: "elle", ramsDomain: "rams.elle.com", displayName: "Elle", notificationAlias: "elle"},
		_pubData{name: "esquire", ramsDomain: "rams.esquire.com", displayName: "Esquire", notificationAlias: "esquire"},
		_pubData{name: "goodhousekeeping", ramsDomain: "rams.goodhousekeeping.com", displayName: "Good Housekeeping", notificationAlias: "ghk"},
		_pubData{name: "mediaos", ramsDomain: "rams.mediaos.com", displayName: "Media OS", notificationAlias: "mediaos"},
		_pubData{name: "harpersbazaar", ramsDomain: "rams.harpersbazaar.com", displayName: "HarpersBAZAAR", notificationAlias: "harpersbazaar"},
		_pubData{name: "housebeautiful", ramsDomain: "rams.housebeautiful.com", displayName: "House Beautiful", notificationAlias: "housebeautiful"},
		_pubData{name: "countryliving", ramsDomain: "rams.countryliving.com", displayName: "Country Living", notificationAlias: "countryliving"},
		_pubData{name: "popularmechanics", ramsDomain: "rams.popularmechanics.com", displayName: "Popular Mechanics", notificationAlias: "popmech"},
		_pubData{name: "delish", ramsDomain: "rams.delish.com", displayName: "Delish", notificationAlias: "delish"},
		_pubData{name: "marieclaire", ramsDomain: "rams.marieclaire.com", displayName: "Marie Claire", notificationAlias: "marieclaire"},
		_pubData{name: "redbook", ramsDomain: "rams.redbookmag.com", displayName: "Redbook", notificationAlias: "redbook"},
		_pubData{name: "townandcountry", ramsDomain: "rams.townandcountrymag.com", displayName: "Town & Country", notificationAlias: "townandcountrymag"},
		_pubData{name: "womansday", ramsDomain: "rams.womansday.com", displayName: "Woman's Day", notificationAlias: "womansday"},
		_pubData{name: "elledecor", ramsDomain: "rams.elledecor.com", displayName: "Elle Decor", notificationAlias: "elledecor"},
		_pubData{name: "roadandtrack", ramsDomain: "rams.roadandtrack.com", displayName: "Road & Track", notificationAlias: "roadandtrack"},
		_pubData{name: "drozthegoodlife", ramsDomain: "rams.drozthegoodlife.com", displayName: "Dr. Oz The Good Life", notificationAlias: "drozthegoodlife"},
		_pubData{name: "bestproducts", ramsDomain: "rams.bestproducts.com", displayName: "Best Products", notificationAlias: "bestproducts"},
		_pubData{name: "veranda", ramsDomain: "rams.veranda.com", displayName: "Veranda", notificationAlias: "veranda"},
		_pubData{name: "lennyletter", ramsDomain: "rams.lennyletter.com", displayName: "Lenny Letter", notificationAlias: "lennyletter"},
